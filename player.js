...
if (navigator.userAgent.match(/(iPhone|iPod|iPad|Android|ios|Nokia|Black Berry|MIDP|Phone)/i) && mobiles === "no") {
	...
	if (myhkLoad && window.location.href.indexOf("https://music.piphp.com/Static/player/music.piphp.com") < 0) {
		$("#myhkplayer").hide()
	} else {
		var songSheetList;
		...
		if (css(span, "font-family") === "FontAwesome") {
			...
			$("head").append("<link rel='stylesheet' id='font-awesome-css'  href='font-awesome.min.css'/*tpa=https://cdn.bootcdn.net/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css*/ type='text/css' media='all' />")
		};
